...
echo '';
echo '<fieldset>';
echo '<img src="Wipro_Logo_RGB.png" height="100px" width="150px"></br></br>';
echo '<h1 class="fs-heading" >Login to your account</h1></br>';
echo '<input type="text" name="username" placeholder=" Username"/><br/>';
echo '<input type="password" name="password" placeholder="Password" /><br/>';
echo '<input type="submit" name="login" class="next action-button" value="Submit" /> <br/> <br/>';
echo '<hr>';
echo '<br/>';
echo '<h3 class="fs-title" >New User? <a href="signup.html">Sign Up</a></h3>';
echo '';
echo '</fieldset>';
echo '';
echo '</form>';
